...
public interface NotificationAttachmentMapper {
     ...
     * This method corresponds to the database table notification_attachment
     *
     ...
     * @mbg.generated Sun Aug 27 18:00:43 ICT 2023
     */
    int updateByExampleSelective(@Param("row") NotificationAttachment row, @Param("example") NotificationAttachmentExample example);
     ...
     * @mbg.generated Sun Aug 27 18:00:43 ICT 2023
     */
    int updateByExample(@Param("row") NotificationAttachment row, @Param("example") NotificationAttachmentExample example);
