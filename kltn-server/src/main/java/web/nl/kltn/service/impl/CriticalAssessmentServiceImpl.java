...
//		List<CriticalAssessmentScoreDTO> assessmentScoreDTOs = criticalAssessmentScoreCusMapper.searchByCAId(ca.getId())
//				.stream().map(caScore -> {
...
//		List<CriticalAssessmentDTO> criticalAssessments = criticalAssessmentCusMapper.searchByThesisId(thesisId)
//				.stream().map(ca -> {
...
//
//	@Override
//	public CriticalAssessmentDTO searchByThesisIdAndMarker(String thesisId, String marker) {
//		return mapCAEntityToDTO(criticalAssessmentCusMapper.searchByThesisAndMarker(thesisId, marker));
//	}
//
//	@Override
...
//				return null;
//			}
//			for (CriticalAssessmentScoreDTO criticalAssessmentScoreDTO : criticalAssessmentDTO
//					.getCritialAssessmentScores()) {
